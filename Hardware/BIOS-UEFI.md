...
Nach dem erfolgreichen POST wird die Kontrolle über den Rechner an den Datenträger übergeben von dem aus ein [[Betriebssysteme - Operating Systems|Betriebssystem]] gestartet werden soll. Der im *Master Boot Record* des Datenträgers enthaltene *Bootloader* für ein bestimmtes OS oder ein *Bootmanager* für eine Auswahl zwischen mehreren Systemen wird daraufhin gestartet.
# ROM
